...
async def play(_, message: Message):
           ...
           for administrator in administrators:
                      if administrator == message.from_user.id:  
                          ...
                          try:
                              ...
                              await lel.edit(
                                  "<b>@Royal_songbot userbot joined your chat</b>",
                              )
                              ...
                              await lel.edit(
                                  ...
                                  "\n\nOr manually add @Royal_songbot to your Group and try again</b>",
                              )
                              pass
    try:
        chatdetails = await USER.get_chat(chid)
        ...
        await lel.edit(
            f"<i> @Royal_songbot Userbot not in this chat, Ask admin to send /play command for first time or add assistant manually</i>"
        )
        return     
    ...
    if message.chat.id in callsmusic.pytgcalls.active_calls:
        ...
        photo="final.png",
        reply_markup=keyboard,
        caption="✯𝗥𝗢𝗬𝗔𝗟 𝗣𝗟𝗔𝗬✯▶️ **Playing** here the song requested by {} 😜".format(
...
async def deezer(client: Client, message_: Message):
    ...
    try:
        ...
        await lel.edit(
            f"<i>Looks like @Royal_songbot Userbot not in this chat, Ask admin to send /play command for first time or add assistant manually</i>"
        )
        return                            
    ...
    if message_.chat.id in callsmusic.pytgcalls.active_calls:
        ...
        appendable = [s_name, r_by, loc]
        qeue.append(appendable)
        await res.edit_text(f"✯𝗥𝗢𝗬𝗔𝗟 𝗣𝗟𝗔𝗬✯=#️⃣ Queued at position {position}")
    else:
        await res.edit_text("✯𝗥𝗢𝗬𝗔𝗟 𝗣𝗟𝗔𝗬✯=▶️ Playing.....")
...
async def jiosaavn(client: Client, message_: Message):
           ...
           for administrator in administrators:
                      if administrator == message_.from_user.id:  
                          ...
                          try:
                              ...
                              await USER.send_message(message_.chat.id,"I joined this group for playing music in VC")
                              await lel.edit(
                                  "<b>@Royal_songbot helper userbot joined your chat</b>",
                              )
    ...
    try:
        ...
        await lel.edit(
            "<i> @Royal_songbot helper Userbot not in this chat, Ask admin to send /play command for first time or add assistant manually</i>"
        )
        return     
    requested_by = message_.from_user.first_name
    chat_id=message_.chat.id
    ...
    if message_.chat.id in callsmusic.pytgcalls.active_calls:
        ...
        m = await client.send_photo(
            ...
            reply_markup=keyboard,
            photo="final.png",
            caption=f"✯𝗥𝗢𝗬𝗔𝗟 𝗣𝗟𝗔𝗬✯=#️⃣ Queued at position {position}",
